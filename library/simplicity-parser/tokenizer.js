...
export function tokenizer(expression) {
    ...
    let index = 0;
    let oldIndex = -1;
    let cursor = {value: null, done: false}
    let tokens = [];
    ...
    return {
        ...
        previous(options = {keyWords: true}) {
            index = tokens[tokens.length - 2].value.index
            oldIndex = null;
