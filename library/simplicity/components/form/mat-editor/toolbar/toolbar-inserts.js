...
class ToolbarInserts extends HTMLElement {
    ...
    link = {
        ...
        click(link) {
            ...
            windowManager.openWindow("library/simplicity/components/form/mat-editor/dialog/link-dialog.js", options).then((matWindow) => {
    ...
    image = {
        ...
        click(event) {
            ...
            windowManager.openWindow("library/simplicity/components/form/mat-editor/dialog/image-upload-dialog.js", options).then((matWindow) => {
                matWindow.addEventListener("ok", (event) => {
                    let value = event.target.contents.value;
                    document.getSelection().removeAllRanges();
                    document.getSelection().addRange(rangeAt);
    ...
    text = {
        ...
        click(event) {
            ...
            windowManager.openWindow("library/simplicity/components/form/mat-editor/dialog/text-dialog.js", options).then((matWindow) => {
                matWindow.addEventListener("ok", (event) => {
                    let value = event.target.contents.value;
                    document.getSelection().removeAllRanges();
                    document.getSelection().addRange(rangeAt);
    ...
    static get template() {
        return libraryLoader("simplicity/components/form/mat-editor/toolbar/toolbar-inserts.html")
    }
