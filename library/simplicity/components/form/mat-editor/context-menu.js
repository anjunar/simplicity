...
class ContextMenu extends HTMLElement {
    ...
    extension() {
        windowManager.openWindow("library/simplicity/components/form/mat-editor/dialog/extended-dialog.js", {
            data: {
                path: this.path
            }
        })
    ...
    static get template() {
        return libraryLoader("simplicity/components/form/mat-editor/context-menu.html")
    }
